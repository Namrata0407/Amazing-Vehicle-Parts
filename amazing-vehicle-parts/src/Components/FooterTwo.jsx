...
import FooterOne from './FooterOne';
  ...
  export default function FooterTwo() {
    return (
     ...
     <div style={{border:'2px solid red',height:'600px',position:'absolute',width:'100%'}}>
         <Box marginTop={'60px'} zIndex={1}> <FooterOne/></Box>
          <Box  w={'100%'} 
        bg={useColorModeValue('#373737', 'gray.900')}
        ...
        <img style={{width:"50px",height:"50px"}} src="https://cdn-icons-png.flaticon.com/128/3955/3955024.png" alt="Instagram" />
        <img style={{width:"50px",height:"50px"}} src="https://cdn-icons-png.flaticon.com/128/3670/3670147.png" alt="youtube" />
        <img style={{width:"50px",height:"50px"}} src="https://cdn-icons-png.flaticon.com/128/733/733609.png" alt="github" />
        <img style={{width:"50px",height:"50px"}} src="https://cdn-icons-png.flaticon.com/128/145/145807.png" alt="linkedIn" />
        </Flex>
        <br/>
         <Divider/>
         <Text pt={6} fontSize={'sm'} textAlign={'center'}>
